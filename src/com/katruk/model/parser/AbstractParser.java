...
/**
 * abstract parser with name and method createXML
 */
	...
	public void createXML(String fileName, Devices devices) {
		...
		try {
			...
			for (Device device : devices.getDevice()) {
				...
				xmlw.writeCharacters(NEW_LINE);		xmlw.writeCharacters(TAB);	xmlw.writeCharacters(TAB);
				...
				xmlw.writeEndElement();
				xmlw.writeCharacters(NEW_LINE);		xmlw.writeCharacters(TAB);
													xmlw.writeCharacters(TAB);	xmlw.writeCharacters(TAB);
