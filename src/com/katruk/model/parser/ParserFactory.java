...
public class ParserFactory {
	...
	public Parser create(ParserType type){
		Parser result = null;
		switch (type){
			case DOMParser  : { result = new DOMParser(ParserType.DOMParser.toString());  	break;}
			case SAXParser  : { result = new SAXParser(ParserType.SAXParser.toString());  	break;}
			case StAXParser : { result = new StAXParser(ParserType.StAXParser.toString());  break;}
		}
		return result;
	}
}
